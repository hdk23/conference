...
class TallyCategoryScore(models.Model):
    ...
    tallies = models.ManyToManyField(TallyScore, blank=True)
    ...
    def calc_tallies(self, committee_average=None, committee_stdev=None):
        ...
        if not self.category.category.scaled:
            print("checking", self.tallies.all())
            points_possible = 0
    ...
    def update_tally(self, tally: TallyScore, old_score: float):
        ...
        self.save()
        print(self.id)
        print("New score is:", self.raw_score)
